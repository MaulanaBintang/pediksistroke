...
def main():
    ...
    st.write("Silahkan mengisi informasi anda!")
    # Display the prediction
    st.title("Hasil Prediksi Resikonya Adalah")
    if st.button('Predict'):
        ...
        # Display the prediction
        if prediction == 0:
            st.write("Tidak ada resiko terjangkit stroke pada tubuh anda")
        else:
            st.write("Terdapat resiko terjangkit stroke pada tubuh anda")
